# reference-fetch-preservation Specification

## Purpose
Define how JDO default-fetch-group intent and the documented EclipseLink one-to-one exception become explicit JPA to-one fetch metadata across composed migration recipes.
